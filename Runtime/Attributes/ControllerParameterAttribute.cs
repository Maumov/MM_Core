...
namespace MM.Attribute
{
    ...
    /// </example>
    public class ControllerParameterAttribute : PropertyAttribute
    {
        public string m_ControllerPath;
        public ControllerParameterAttribute(string i_ControllerPath)
        {
            m_ControllerPath = i_ControllerPath;
        }
    }
}
